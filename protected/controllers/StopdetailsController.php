...
class StopdetailsController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Stopdetails']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->stopID));
		}
	 ...
	 * @return Stopdetails the loaded model
	 ...
	 * @param Stopdetails $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='stopdetails-form')
		{
