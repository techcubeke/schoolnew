...
class FinancialyearController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Financialyear']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->financialyearID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Financialyear');
	...
	{
		$model=new Financialyear('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Financialyear']))
			$model->attributes=$_GET['Financialyear'];
