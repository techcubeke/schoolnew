...
class VisitorpassController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Visitorpass']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->visitorpassID));
		}
	 ...
	 * @return Visitorpass the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Visitorpass::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Visitorpass $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='visitorpass-form')
		{
