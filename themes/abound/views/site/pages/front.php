...
<title>Front Deskl</title>
<link href="../../../css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<div class="page-header">
  <h1 class="offset5">Front Desk<small> Portal</small></h1>
</div>
</head>
		...
		<div class="sidebar-nav">
		  ...
		  <?php $this->widget('zii.widgets.CMenu', array(
			...
			'items'=>array(
				...
				array('label'=>'<i class="icon icon-envelope"></i> Front Desk Portal <span class="badge badge-success pull-right"></span>', 'url'=>'#'),
...
<div class="row">
	<div class="span3 offset1">
			<button class="btn btn-info" type="submit"  onclick="document.location.href = '../visitorpass'">Visitor Pass</button>
	</div>
	<div class="span3 offset2">
			<button class="btn btn-info" type="submit"  onclick="document.location.href = '../appointment'">Appointment</button>
	</div>
</div>
<br />
<br />
<div class="row">
	<div class="span3 offset1">
			<button class="btn btn-info" type="submit"  onclick="document.location.href = '../feedbackarea'">Feedback</button>
	</div>
	<div class="span3 offset2">
