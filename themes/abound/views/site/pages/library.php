...
<div class="page-header">
  <h1 class="offset5">Library<small> Portal</small></h1>
</div>
</head>
		...
		<div class="sidebar-nav">
		  ...
		  <?php $this->widget('zii.widgets.CMenu', array(
			...
			'items'=>array(
				...
				array('label'=>'<i class="icon icon-envelope"></i> Library Portal <span class="badge badge-success pull-right"></span>', 'url'=>'#'),
...
<div class="row">
	<div class="span3 offset1">
			<button class="btn btn-info" type="submit"  onclick="document.location.href = '../bookissuereturn'">Issue Books</button>
	</div>
	<div class="span3 offset2">
			<button class="btn btn-info" type="submit"  onclick="document.location.href = '../book'">Book Records</button>
	</div>
</div><br />
